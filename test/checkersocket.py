...
class CheckerSocket:
    def __init__(self, addr) -> None:
        ...
        fh = logging.FileHandler(
            filename=os.path.join(log_dir, "Checker.log"), mode="w"
        )
    ...
    def recv_pkt_from(self):
        ...
        (
            ...
            s_head_lSrcPort,
            s_head_lDestPort,
        ) = struct.unpack("I4s4sHH", mixedheaders[:SpiffyHeaderLen])
        ...
        magic, team, pkt_type, header_len, pkt_len, seq, ack = struct.unpack(
            "HBBHHII", mixedheaders[SpiffyHeaderLen:]
        )
